...
Homeassistant Bridge is a lightweight Python MeshMonitor bridge that connects Home Assistant to MeshMonitor using MQTT.
...
* Eclipse Mosquitto (MQTT reference broker) 
